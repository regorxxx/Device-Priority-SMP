<h1 align="center">Device-Priority-SMP</h1>
...
## Installation
See [Wiki](https://github.com/regorxxx/Device-Priority-SMP/wiki/Installation) or the [_INSTALLATION (txt)](https://github.com/regorxxx/Device-Priority-SMP/blob/main/_INSTALLATION.txt).
